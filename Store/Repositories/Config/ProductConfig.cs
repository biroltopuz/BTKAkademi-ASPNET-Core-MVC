    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 8, CategoryId = 1, ImageUrl = "/images/8.jpg", ProductName = "My Notebook", Price = 50 },
                new Product() { ProductId = 9, CategoryId = 3, ImageUrl = "/images/9.jpg", ProductName = "IPhone X", Price = 15000 },
                new Product() { ProductId = 10, CategoryId = 3, ImageUrl = "/images/10.jpg", ProductName = "Samsung Galaxy Note FE", Price = 15000 },
                new Product() { ProductId = 11, CategoryId = 3, ImageUrl = "/images/11.jpg", ProductName = "IPhone 14", Price = 22000 }
            );
        }
    }
}